<div>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Lista de Trabajos del Tag </h1>
    ...
    <div class="row mb-3 p-2">
        ...
        <div class=" col-md-3 p2">
            <div wire:ingone>
                <label class="invisible" for="tag" class="text-warning">Tag</label>
                <input type="text" style="text-transform:uppercase" wire:model.defer="tag"
                    ...
                    placeholder="Introducir nombre del Tag" readonly="readonly" >
                @error('tag')
                                        ...
                                        @foreach ($trabajos as $trabajo)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($trabajo->statustraba->status_trabajos != 'TERMINADO' )
                                                        <a href="{{ route('admin.falla.list-consulta-fallas', $trabajo->id) }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" wire:model.defer="descripcionfalla"
                                class="form-control @error('descripcionfalla') is-invalid @enderror" id="descripcionfalla"
                                aria-describedby="descripcionfallaHelp" readonly="readonly" rows="3"></textarea>
                        ...
                        {{-- Descripcion de la Trabajo --}}
                        <div class="form-group">
                            <label for="descripciontrabajo1">Descripcion de Trabajo</label>
                            <textarea type="text" style="text-transform:uppercase" wire:model.defer="descripciontrabajo1"
                                class="form-control @error('descripciontrabajo1') is-invalid @enderror" id="descripciontrabajo1"
                                aria-describedby="descripciontrabajo1Help" rows="3"></textarea>
