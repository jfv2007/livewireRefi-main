                                        ...
                                        @foreach ($fallas as $falla)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($falla->fllastatus->status_revison == 'ATENDIDO')
                                                        <a href="{{ route('admin.trabajo.list-consulta-trabajos', $falla->id) }}"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="Consultar trabajos de tag">
                                                            <i class="fas fa-address-book mr-2"></i>
                                                        </a>
                                                    {{-- @elseif($tag18->ttrabajo) --}}
                                                    @endif
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" wire:model.defer="descripcion"
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" style="text-transform:uppercase"
                                wire:model.defer="descripcionfalla"
                                class="form-control @error('descripcionfalla') is-invalid @enderror"
                                id="descripcionfalla" aria-describedby="descripcionfallaHelp" rows="3"></textarea>
