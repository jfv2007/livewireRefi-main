...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- <link rel="styleshet" href="/js/color-modes.js">
    ...
    <body>
      ...
      <main>
        ...
        <div class="b-example-divider"></div>
              ...
              <div class=relative flex items-top justify-left min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0>
